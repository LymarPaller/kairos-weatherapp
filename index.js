...
const weatherImageSrcSecond = document.getElementById(
  "current-weather-img-second"
);
...
const weatherImageSrcThird = document.getElementById(
  "current-weather-img-third"
);
...
const weatherImageSrcFourth = document.getElementById(
  "current-weather-img-fourth"
);
...
const forecastImgAnimA = document.querySelectorAll(
  "#main-city .forecast-container #forecast-weather-img-a"
);
const forecastImgAnimB = document.querySelectorAll(
  "#main-city .forecast-container #forecast-weather-img-b"
);
const forecastImgAnimC = document.querySelectorAll(
  "#main-city .forecast-container #forecast-weather-img-c"
);
const forecastImgAnimD = document.querySelectorAll(
  "#main-city .forecast-container #forecast-weather-img-d"
);
const forecastImgAnimE = document.querySelectorAll(
  "#main-city .forecast-container #forecast-weather-img-e"
);
...
function setCurrentWeatherImage(currentConditionText) {
  ...
  if (lowercaseConditionText.includes("sunny")) {
    ...
    lowercaseConditionText.includes("mist") ||
    lowercaseConditionText.includes("fog")
  ) {
    imageSrc = "./photo/weather-images/weather-mist-fog.svg";
  } else if (
    lowercaseConditionText.includes("snow") &&
    lowercaseConditionText.includes("thunder")
  ) {
...
const successCallback = (position) => {
  ...
  fetch(
    `https://api.openweathermap.org/geo/1.0/reverse?lat=${latitude}&lon=${longitude}&appid=42207e457e3eb8b6df3dd8146f5bfc1b`
  )
    .then((result) => {
      if (result.ok) {
        return result.json();
...
document.addEventListener("DOMContentLoaded", function () {
  const cities = document.querySelectorAll(
    ".second-city, .third-city, .fourth-city"
  );
...
const getCityName = () => {
  ...
  fetch(
    `https://api.weatherapi.com/v1/forecast.json?key=${forecastAPIKEY}%20&q=${secondCityName}&days=7&aqi=no&alerts=no`
  )
    .then((result) => {
      if (result.ok) {
        return result.json();
    ...
    .then((data) => {
      ...
      const forecastDayAnim = document.querySelectorAll(
        ".city-one .forecast-container .forecast-day"
      );
      const forecastImgAnimA = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-a"
      );
      const forecastImgAnimB = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-b"
      );
      const forecastImgAnimC = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-c"
      );
      const forecastImgAnimD = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-d"
      );
      const forecastImgAnimE = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-e"
      );
      const forecastImgAnimF = document.querySelectorAll(
        ".city-one .forecast-container #second-forecast-weather-img-f"
      );
      ...
      document
        .getElementById("widget-temp-second")
        .addEventListener("click", toggleUnits);
...
const getCityName2 = () => {
  ...
  fetch(
    ...
    .then((data) => {
      ...
      document
        .getElementById("widget-temp-third")
        .addEventListener("click", toggleUnits);
      ...
      const timeWidget = document.querySelectorAll(
        ".city-two .status-widget-1"
      );
      const forecastDayAnim = document.querySelectorAll(
        ".city-two .forecast-container .forecast-day"
      );
      const forecastImgAnimA = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-a"
      );
      const forecastImgAnimB = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-b"
      );
      const forecastImgAnimC = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-c"
      );
      const forecastImgAnimD = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-d"
      );
      const forecastImgAnimE = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-e"
      );
      const forecastImgAnimF = document.querySelectorAll(
        ".city-two .forecast-container #third-forecast-weather-img-f"
      );
